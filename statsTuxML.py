...
def stats(csvFilename):
	...
	* Informations sur le temps de compilation"""
	with open(csvFilename) as csvFile :
		...
		coef2 = graphInfo(tabActive, tabCompTime, "Temps de compilation en fonction du nombre d'options actives(y/m)")
		plt.xlabel("Nombre options actives")
		plt.ylabel("Temps compilation (s)")
		plt.show()
		print("Coefficient de correlation :", coef2[0][1])
		coef3 = graphInfo(tabActive, tabSize, "Taille du kernel en fonction du nombre d'options actives(y/m)")
		plt.xlabel("Nombre options actives")
		...
		coef4 = graphInfo(tabY, tabCompTime, "Temps de compilation en fonction du nombre d'options actives(y)")
		plt.xlabel("Nombre options actives")
		plt.ylabel("Temps compilation (s)")
		plt.show()
		print("Coefficient de correlation :", coef4[0][1])
		coef5 = graphInfo(tabY, tabSize, "Taille du kernel en fonction du nombre d'options actives(y)")
		plt.xlabel("Nombre options actives")
		plt.ylabel("Taille kernel (Mo)")
		plt.show()
		...
		coef6 = graphInfo(tabM, tabCompTime, "Temps de compilation en fonction du nombre d'options actives(m)")
		plt.xlabel("Nombre options actives")
		plt.ylabel("Temps compilation (s)")
		plt.show()
		print("Coefficient de correlation :", coef6[0][1])
		coef7 = graphInfo(tabM, tabSize, "Taille du kernel en fonction du nombre d'options actives(m)")
		plt.xlabel("Nombre options actives")
		plt.ylabel("Taille kernel (Mo)")
		plt.show()
